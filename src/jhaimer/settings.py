...
SECRET_KEY = 'django-insecure-5l)@2f@$1nhigt@b_aguyf5%dh1i2n59#&z81u%x6bvgcvqozn'
...
DATABASE_ENGINE_NAME = config('DATABASE_ENGINE_NAME', cast=str, default="django.db.backends.postgresql")
DATABASE_USER_NAME = config('DATABASE_USER_NAME', cast=str)
...
MEDIA_URL = 'media/'
MEDIA_ROOT = os.path.join(LOCAL_CDN, 'social_platform_media_files')
